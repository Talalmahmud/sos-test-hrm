...
const Category2 = (props: Props) => {
  ...
  return (
    <div className=" p-[16px] w-full border-[1px] border-bg_orange rounded-[16px]">
      ...
      <div className=" w-full pt-[24px] px-[8px] lg:px-[0px] grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5  gap-2 xl:gap-[16px] items-center ">
        {categoryList?.map((item: any, index: any) => (
          <div key={index} className=" flex-1 ">
            <CatagoryCard cardData={item} title={item?.category_name} />
          </div>
        ))}
      </div>
    </div>
