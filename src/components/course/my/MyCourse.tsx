        ...
        <table className="w-full shadow-md ">
          <thead className="bg-[#DBDDE2]">
            <tr className=" text-left">
              <th className="pl-1 text-[13px] font-semibold">Name</th>
              <th className=" text-[13px] font-semibold">Phone</th>
              <th className=" text-[13px] font-semibold">Owner</th>
              <th className=" text-[13px] font-semibold">Session</th>
              <th className=" text-[13px] font-semibold">Semester</th>

              <th className=" text-[13px] font-semibold">Course</th>
              <th className=" text-[13px] font-semibold">Department</th>
              <th className=" text-[13px] font-semibold">Package</th>
              <th className=" text-[13px] font-semibold">Course Fee</th>
              <th className=" text-[13px] font-semibold">Pay Done</th>
              <th className=" text-[13px] font-semibold">Due</th>
            </tr>
          </thead>
          <tbody>
            {isLoading ? (
              ...
              enrollmentList?.map((enroll: any, index: number) => (
                <tr
                  key={index}
                  className={`hover:bg-bg_card shadow-md whitespace-nowrap cursor-pointer text-[12px] align-top text-left py-[8px] ${
                    index % 2 === 0 && " bg-orange"
                  }}`}
                >
                  <td className="pl-1 py-4 text-orange ">
                    <Link
                  ...
                  <td className=" py-4">{enroll?.payment_number}</td>
                  <td className=" py-4">{enroll?.employee?.name}</td>
                  <td className=" py-4">
                  ...
                  <td className=" py-4">{enroll?.category?.category_name}</td>
                  <td className=" py-4">
                  ...
                  <td className=" py-4">{enroll?.course_fee}/-</td>
                  <td className=" py-4">{enroll?.payable_fee}/-</td>
                  <td className=" py-4">
                    {enroll?.course_fee - enroll?.payable_fee}/-
                  </td>
                </tr>
              ))
            )}
