...
import SemesterPackageForm from "./SemesterPackageForm";
...
const SemesterPackage = (props: Props) => {
  ...
  const getAll = async () => {
    ...
    const res = await axios.get(EndPoint.GET_ALL_SEMESTER_PACKAGE);
  ...
  const deleteCustomDate = async (custom_id: any) => {
    try {
      const res = await axios.delete(
        EndPoint.DELETE_SEMESTER_PACKAGE + custom_id
      );
            ...
            {isLoading ? (
              ...
              listData?.map((item: any, index: any) => (
                ...
                >
                  ...
                  <td>
                    {item?.semester_schedule?.map(
                      (item: any, index: number) => (
                        <p key={index} className=" bg-green text-white">
...
export default SemesterPackage;
